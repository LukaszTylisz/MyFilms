<template>
      ...
      <button id="show-modal" class="btn btn-lg mb-4 glow-on-hover" @click  ="openModal('Add Movie', false)">Add Movie</button>
      <button type="button" class="btn btn-lg btn-secondary mb-4 mx-1" @click="fetchMovies">Fetch Data</button>
            ...
            <tr v-for="movie in movies" :key="movie.id">
              ...
              <td>
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-info mx-1 text-white" @click="editMovie(movie)">Edit</button>
